...
import GradesMainContent    from './main-content';
...
class AppGrades extends Component {
    ...
    renderGrades() {
        ...
        return (
            <AppBar className={`${classes.root} app app-grades`}
                    position="fixed"
                    elevation={1}
                    >
        ...
        return (
            <div className="AppGrades">
                ...
                {newActivities.length>0 &&
                    <GradesMainContent filteredActivities={newActivities} />
                }
...
export default connect(mapStateToProps, mapDispatchToProps)( withStyles(styles)(AppGrades) );